...
if [ ! -f $build/bin/funasr-onnx-2pass-rtf ]; then 
...
punc_dir="../websocket/models/damo/punc_ct-transformer_zh-cn-common-vad_realtime-vocab272727-onnx"
...
$build/bin/funasr-onnx-2pass-rtf  \
  --model-dir ${model_dir} \
  ...
  --onnx-inter-thread  ${onnx_thread_num} \
  --wav-path  ${wav_path} \
  --mode ${asr_mode}
